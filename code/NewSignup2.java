...
public class NewSignup2 extends JFrame implements ActionListener {
	...
	NewSignup2(){
		...
		super("NEW ACCOUNT APPLICATION FORM- PAGE 2");
				...
				String occupation[]= {"Student","Self-Employmed","Business","Retired","other"};
				...
				l12.setBounds(660,70,100,30);
				add(l12);
				t3.setBounds(720,70,100,30);
				add(t3);
				l1.setBounds(100,70,600,40);
				add(l1);
